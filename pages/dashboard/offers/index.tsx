...
const OffersTable = dynamic(
  () => import('@/components/dashboard/offers/OffersTable'),
  {
...
import { useGetAllSelfOffersMutation } from '@/redux/api/offerSlice';
...
const OffersPage = () => {
  ...
  const [getAllOffers, { isLoading }] = useGetAllSelfOffersMutation();
...
OffersPage.getLayout = (page) => (
  <SidebarLayout title="Appels d'offres | Cafila" noFooter>
    {page}
  </SidebarLayout>
);
